...
public class _4_SkladniaPetli {
    ...
    public static void doWhile() {
        int i = 1;
        do {                                    // do instrukcje, a warunek while na koncu. zawszze program raz wykona do (nawet jak nie spelnia warunku)
            System.out.println("w pętli: " + i);
            i++;
        } while (i <= 5);
        System.out.println("za pętlą: " + i);
    ...
    public static void losowanie() {
        for (;;) {                      //(;;)-petla  nieskonczona
            ...
            if (x > 0.8)
                break; //break do przerywania petli
        }
    ...
    public static void forEach() {
        ...
        for(String imie : imiona) {                             //do przegladania list
    ...
    public static void przerwanie() {
        for (int i = 1; i <= 10; i++) {
            ...
            if (i % 2 == 1) {
                ...
                continue;                                           //pomin pozostale warunki petli i wroc na poczatek petli
            }
    ...
    public static int etykiety() {
        ...
        while(true) {
            for(int i = 1; i < 10; i++) {
                suma += i;
                if (suma > 100)
                    break duza;   // duza to etykieta (label) i przerywa petle w 2 miejscach tam gdzie jest slowo "duza"
            }
        }
        return suma;
    }
